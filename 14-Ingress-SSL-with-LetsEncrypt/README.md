...
app1-google-secret   True    app1-google-secret   45m
app2-google-secret   True    app2-google-secret   45m
stack@Azure:~$
```

```log
# Sample Success Log
I0824 13:09:00.495721       1 controller.go:129] cert-manager/controller/orders "msg"="syncing item" "key"="default/app2-google-secret-2792049964-67728538" 
I0824 13:09:00.495900       1 sync.go:102] cert-manager/controller/orders "msg"="Order has already been completed, cleaning up any owned Challenge resources" "resource_kind"="Order" "resource_name"="app2-google-secret-2792049964-67728538" "resource_namespace"="default" 
I0824 13:09:00.496904       1 controller.go:135] cert-manager/controller/orders "msg"="finished processing work item" "key"="default/app2-google-secret-2792049964-67728538
```

## Step-10: Access Application
```t
# URLs
http://sapp1.google.com/app1/index.html
http://sapp2.google.com/app2/index.html
```

...
git remote add origin https://github.com/nholuongut/azure-devops-github-acr-aks-app1.git

# Push to Remote Repository
git push --set-upstream origin master

# Go to Github Repo - Refresh and check files appeared in githbu repo
https://github.com/nholuongut/azure-devops-github-acr-aks-app1
```
...
- Click on **Add**
- Subscription: nholuongut-Paid-Subsciption

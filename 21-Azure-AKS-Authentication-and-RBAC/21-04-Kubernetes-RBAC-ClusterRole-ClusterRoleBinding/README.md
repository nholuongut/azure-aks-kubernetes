...
AKS_READONLY_USER_OBJECT_ID=$(az ad user create \
  ...
  --user-principal-name aksread1@nholuongutgmail.onmicrosoft.com \
  --password @AKSDemo123 \
...
- Username: aksread1@nholuongutgmail.onmicrosoft.com
- Password: @AKSDemo123
...
Error from server (Forbidden): namespaces is forbidden: User "aksread1@nholuongutgmail.onmicrosoft.com" cannot create resource "namespaces" in API group "" at the cluster scope
...
# Users
  - user1aksadmin@nholuongutgmail.onmicrosoft.com 
  - aksdev1@nholuongutgmail.onmicrosoft.com
  - aksread1@nholuongutgmail.onmicrosoft.com
# Groups
  - k8sadmins
  - devaksteam
  - aksreadonly

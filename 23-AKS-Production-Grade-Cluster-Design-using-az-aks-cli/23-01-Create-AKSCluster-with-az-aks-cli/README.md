...
# Replace with your AD Domain - aksadmin1@nholuongutgmail.onmicrosoft.com
AKS_AD_AKSADMIN1_USER_OBJECT_ID=$(az ad user create \
  --display-name "AKS Admin1" \
  --user-principal-name aksadmin1@nholuongutgmail.onmicrosoft.com \
  --password @AKSDemo123 \
...
Username: aksadmin1@nholuongutgmail.onmicrosoft.com
Password: @AKSDemo123
```
